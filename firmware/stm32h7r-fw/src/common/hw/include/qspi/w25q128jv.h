...
/**
  * @brief  W25Q128JV Registers
  */
/* Status Register */
#define W25Q128JV_SR_WIP                      ((uint8_t)0x01)    /*!< Write in progress */
#define W25Q128JV_SR_WREN                     ((uint8_t)0x02)    /*!< Write enable latch */
#define W25Q128JV_SR_BLOCKPR                  ((uint8_t)0x5C)    /*!< Block protected against program and erase operations */
#define W25Q128JV_SR_PRBOTTOM                 ((uint8_t)0x20)    /*!< Protected memory area defined by BLOCKPR starts from top or bottom */
#define W25Q128JV_SR_SRWREN                   ((uint8_t)0x80)    /*!< Status register write enable/disable */
